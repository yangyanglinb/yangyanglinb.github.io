...
Yangyang Li
======
China  |  liyangyangnb@gmail.com  |  (+86)18551758121 |  [GitHub](https://github.com/yangyanglinb)
...
and temporal data understanding. 
...
* **Graph-aware Time–Frequency Contrastive Learning Framework (contrastive-twfreq)**  
  ...
  * Performed graph-structure fusion of time–frequency features using Graph Neural 
    Networks (GNNs) to capture inter-variate dependencies and model multi-scale 
...
* **A Novel ARM-DC AutoConNet for Accurate Long-Term Time-Series Forecasting**  
  ...
  * Evaluated on 16 public datasets (e.g., M4, M5, ETTh1, ETTm1, Traffic), achieving up 
    to ~95% MSE reduction and ~77% MAE reduction.  

* **Using YOLOv3 for Vehicle Tracking in DonkeyCar**  
  *Sep 2023 – Jul 2025*  
  * Proposed a dual-vehicle cooperative autonomous driving method fusing YOLOv3 visual 
    detection with control algorithms to realize front-vehicle tracking and obstacle 
    avoidance.  
  * Demonstrated robust multi-vehicle collaboration using camera-only perception under 
